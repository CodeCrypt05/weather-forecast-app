...
class ComfartLevel extends StatelessWidget {
  final WeathreDataCurrent weathreDataCurrent;
  const ComfartLevel({super.key, required this.weathreDataCurrent});
            ...
            children: [
              Center(
                child: SleekCircularSlider(
                  min: 0,
                  max: 100,
                  initialValue: weathreDataCurrent.current.humidity!.toDouble(),
                ...
                children: [
                  RichText(
                    text: TextSpan(children: [
                      ...
                      TextSpan(
                        text:
                            "${(weathreDataCurrent.current.feelsLike! - 273.15).toInt()}°",
                  ...
                  RichText(
                    text: TextSpan(children: [
                      ...
                      TextSpan(
                        text: "${weathreDataCurrent.current.uvIndex}",
                        style: const TextStyle(
                          fontSize: 14,
                          height: 0.8,
                          color: CustomColors.textColorBlack,
